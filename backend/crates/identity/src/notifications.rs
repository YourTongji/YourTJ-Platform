//! Notifications domain: list and mark-read for the current user.
//!
//! Lives in the identity crate (simple CRUD, references identity.accounts) even
//! though the backing table is `forum.notifications`.
