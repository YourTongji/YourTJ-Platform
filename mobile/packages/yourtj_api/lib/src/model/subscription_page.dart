...
class SubscriptionPage {
  /// Returns a new [SubscriptionPage] instance.
  SubscriptionPage({
    required this.items,
  ...
  factory SubscriptionPage.fromJson(Map<String, dynamic> json) =>
      _$SubscriptionPageFromJson(json);

  Map<String, dynamic> toJson() => _$SubscriptionPageToJson(this);
