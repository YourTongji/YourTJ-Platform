...
class Thread {
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: ThreadStatusEnum.unknownDefaultOpenApi,
  )
  final ThreadStatusEnum status;
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: true,
    unknownEnumValue: ThreadViewerVoteEnum.unknownDefaultOpenApi,
  )
  final ThreadViewerVoteEnum? viewerVote;
...
enum ThreadStatusEnum {
  ...
  const ThreadStatusEnum(this.value);
...
enum ThreadViewerVoteEnum {
  ...
  const ThreadViewerVoteEnum(this.value);
