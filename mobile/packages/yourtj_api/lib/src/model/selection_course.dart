...
class SelectionCourse {
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: SelectionCourseReviewScopeEnum.unknownDefaultOpenApi,
  )
  final SelectionCourseReviewScopeEnum reviewScope;
...
/// Whether the historical aggregate matched the current teacher identity, fell back to a course-level alias, or has no data.
enum SelectionCourseReviewScopeEnum {
  /// Whether the historical aggregate matched the current teacher identity, fell back to a course-level alias, or has no data.
  @JsonValue(r'none')
  none(r'none'),
  ...
  const SelectionCourseReviewScopeEnum(this.value);
