...
class ActivityApi {
  ...
  /// Returns every Asia/Shanghai calendar day in the requested inclusive range, including zero-count days. The maximum range is 371 days.
  ///
  /// Parameters:
  /// * [from]
  /// * [to]
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ActivityCalendar] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ActivityCalendar>> meActivityGet({
    DateTime? from,
    DateTime? to,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    ActivityCalendar? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<ActivityCalendar, ActivityCalendar>(
              rawData,
              'ActivityCalendar',
              growable: true,
            );
    ...
    return Response<ActivityCalendar>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CheckInStatus] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CheckInStatus>> meCheckInGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    CheckInStatus? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<CheckInStatus, CheckInStatus>(
              rawData,
              'CheckInStatus',
              growable: true,
            );
  ...
  /// Idempotent; a repeated request returns the existing check-in without adding activity again.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Returns a [Future] containing a [Response] with a [CheckInStatus] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CheckInStatus>> meCheckInPost({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns the authoritative tea trust level, live qualifying score, next threshold, and override state.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Returns a [Future] containing a [Response] with a [TrustProgress] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TrustProgress>> meTrustProgressGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/me/trust-progress';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
