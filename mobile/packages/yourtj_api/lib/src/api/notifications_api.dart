...
class NotificationsApi {
  ...
  /// Notices contain no staff identity, reporter identity, or private evidence.
  ///
  /// Parameters:
  /// * [unread]
  /// * [cursor] - Opaque pagination cursor
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GovernanceNoticePage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GovernanceNoticePage>> meGovernanceNoticesGet({
    bool? unread = false,
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    ...
    final _path = r'/me/governance-notices';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    GovernanceNoticePage? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<GovernanceNoticePage, GovernanceNoticePage>(
              rawData,
    ...
    return Response<GovernanceNoticePage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> meGovernanceNoticesReadPost({
    required GovernanceNoticeReadInput governanceNoticeReadInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/me/governance-notices/read';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      _bodyData = jsonEncode(governanceNoticeReadInput);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MeGovernanceNoticesUnreadCountGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MeGovernanceNoticesUnreadCountGet200Response>>
  meGovernanceNoticesUnreadCountGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/me/governance-notices/unread-count';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    MeGovernanceNoticesUnreadCountGet200Response? _responseData;
    ...
    return Response<MeGovernanceNoticesUnreadCountGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NotificationPrefs] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationPrefs>> meNotificationPrefsGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/me/notification-prefs';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    NotificationPrefs? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<NotificationPrefs, NotificationPrefs>(
              rawData,
              'NotificationPrefs',
              growable: true,
            );
    ...
    return Response<NotificationPrefs>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [NotificationPrefs] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationPrefs>> meNotificationPrefsPut({
    required NotificationPrefsInput notificationPrefsInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(notificationPrefsInput);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Send ids to mark selected notifications or all&#x3D;true to mark every notification. For rolling compatibility, an empty object still means mark all; new clients must send all&#x3D;true explicitly.
  ///
  /// Parameters:
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> notificationsReadPost({
    required NotificationReadInput notificationReadInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(notificationReadInput);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Best-effort refresh hints only. The stream emits sync immediately after every connection; clients must refetch durable notification and unread-count endpoints after sync or any event.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> notificationsStreamGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/notifications/stream';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationUnreadCount>> notificationsUnreadCountGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<NotificationUnreadCount, NotificationUnreadCount>(
              rawData,
