...
class SelectionApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<Calendar>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Calendar>>> selectionCalendarsGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/selection/calendars';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
    ...
    List<Calendar>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<Calendar>, Calendar>(
              rawData,
              'List<Calendar>',
              growable: true,
            );
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<Campus>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Campus>>> selectionCampusesGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/selection/campuses';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    List<Campus>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<Campus>, Campus>(
              rawData,
              'List<Campus>',
              growable: true,
            );
  ...
  Future<Response<List<CourseNature>>> selectionCourseNaturesGet({
    ...
    final _path = r'/selection/course-natures';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    List<CourseNature>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<CourseNature>, CourseNature>(
              rawData,
              'List<CourseNature>',
              growable: true,
            );
    ...
    return Response<List<CourseNature>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<List<SelectionCourse>>> selectionCoursesByMajorGet({
    ...
    final _path = r'/selection/courses-by-major';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  Future<Response<List<SelectionCourse>>> selectionCoursesByNatureGet({
    ...
    final _path = r'/selection/courses-by-nature';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  Future<Response<SelectionCourse>> selectionCoursesCodeGet({
    ...
    SelectionCourse? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<SelectionCourse, SelectionCourse>(
              rawData,
              'SelectionCourse',
              growable: true,
            );
    ...
    return Response<SelectionCourse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<Faculty>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Faculty>>> selectionFacultiesGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/selection/faculties';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    List<Faculty>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<Faculty>, Faculty>(
              rawData,
              'List<Faculty>',
              growable: true,
            );
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<String>>> selectionGradesGet({
    ...
    final _path = r'/selection/grades';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LatestUpdate] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LatestUpdate>> selectionLatestUpdateGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/selection/latest-update';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    LatestUpdate? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<LatestUpdate, LatestUpdate>(
              rawData,
              'LatestUpdate',
              growable: true,
            );
  ...
  Future<Response<List<Major>>> selectionMajorsGet({
    ...
    final _path = r'/selection/majors';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    List<Major>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<Major>, Major>(
              rawData,
              'List<Major>',
              growable: true,
            );
