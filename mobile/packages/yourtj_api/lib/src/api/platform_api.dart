...
class PlatformApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Announcement>>> announcementsGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AnnouncementReceipt] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AnnouncementReceipt>> announcementsIdReceiptPost({
    required String id,
    required AnnouncementReceiptInput announcementReceiptInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/announcements/{id}/receipt'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
    ...
    try {
      _bodyData = jsonEncode(announcementReceiptInput);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
    ...
    AnnouncementReceipt? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<AnnouncementReceipt, AnnouncementReceipt>(
              rawData,
              'AnnouncementReceipt',
              growable: true,
            );
    ...
    return Response<AnnouncementReceipt>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [List<Announcement>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Announcement>>> announcementsUnreadGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/announcements/unread';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<HealthStatus>> healthGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<HealthStatus, HealthStatus>(
              rawData,
              'HealthStatus',
              growable: true,
            );
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [OneboxResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OneboxResult>> oneboxGet({
    required String url,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    OneboxResult? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<OneboxResult, OneboxResult>(
              rawData,
              'OneboxResult',
              growable: true,
            );
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<Promotion>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Promotion>>> promotionsGet({
    String? placement,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    List<Promotion>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<Promotion>, Promotion>(
              rawData,
              'List<Promotion>',
              growable: true,
            );
    ...
    return Response<List<Promotion>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// A click implicitly records the matching impression when it was not delivered first. The signed presentation token contains no account, IP, or device identifier.
  ///
  /// Parameters:
  /// * [id]
  /// * [promotionEventInput]
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> promotionsIdEventsPost({
    required String id,
    required PromotionEventInput promotionEventInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/promotions/{id}/events'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
    ...
    try {
      _bodyData = jsonEncode(promotionEventInput);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Returns a [Future] containing a [Response] with a [HealthStatus] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<HealthStatus>> readyGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<Setting>>> settingsGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> startupVerifyPost({
    required StartupVerifyPostRequest startupVerifyPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(startupVerifyPostRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
