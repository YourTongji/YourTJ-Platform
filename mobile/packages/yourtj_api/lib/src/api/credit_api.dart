...
class CreditApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductPage>> creditProductsGet({
    String? status,
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<ProductPage, ProductPage>(
              rawData,
              'ProductPage',
              growable: true,
            );
  ...
  /// Parameters:
  /// * [id]
  /// * [xWalletIntent] - One-time signing intent returned by POST /credit/signing-intents
  /// * [xWalletSig] - Base64 Ed25519 signature over the intent's exact signingBytes
  /// * [idempotencyKey]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Purchase] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Purchase>> creditProductsIdPurchasePost({
    required String id,
    required String xWalletIntent,
    required String xWalletSig,
    required String idempotencyKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/credit/products/{id}/purchase'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
    ...
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'X-Wallet-Intent': xWalletIntent,
        r'X-Wallet-Sig': xWalletSig,
        r'Idempotency-Key': idempotencyKey,
        ...?headers,
      },
      extra: <String, dynamic>{
    ...
    Purchase? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<Purchase, Purchase>(
              rawData,
              'Purchase',
              growable: true,
            );
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Product>> creditProductsPost({
    ...
    try {
      _bodyData = jsonEncode(productInput);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PurchasePage>> creditPurchasesGet({
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/credit/purchases';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<PurchasePage, PurchasePage>(
              rawData,
              'PurchasePage',
              growable: true,
            );
  ...
  /// * [id]
  /// * [purchaseAction]
  /// * [xWalletIntent] - Required only for the value-moving actions documented on this operation
  /// * [xWalletSig] - Required only for the value-moving actions documented on this operation
  /// * [idempotencyKey]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> creditPurchasesIdActionPost({
    required String id,
    required PurchaseAction purchaseAction,
    String? xWalletIntent,
    String? xWalletSig,
    ...
    final _path = r'/credit/purchases/{id}/action'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
    ...
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xWalletIntent != null) r'X-Wallet-Intent': xWalletIntent,
        if (xWalletSig != null) r'X-Wallet-Sig': xWalletSig,
    ...
    try {
      _bodyData = jsonEncode(purchaseAction);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SigningIntent] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SigningIntent>> creditSigningIntentsPost({
    required String idempotencyKey,
    required SigningIntentInput signingIntentInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/credit/signing-intents';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Idempotency-Key': idempotencyKey,
    ...
    try {
      _bodyData = jsonEncode(signingIntentInput);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
    ...
    SigningIntent? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<SigningIntent, SigningIntent>(
              rawData,
              'SigningIntent',
              growable: true,
            );
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TaskPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TaskPage>> creditTasksGet({
    String? status,
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    ...
    TaskPage? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<TaskPage, TaskPage>(
              rawData,
              'TaskPage',
              growable: true,
            );
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> creditTasksIdAcceptPost({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/credit/tasks/{id}/accept'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// confirm/cancel/reject and an open-task delete require wallet intent, signature and idempotency headers; submit and deletion after cancellation do not move value.
  ///
  /// Parameters:
  /// * [id]
  /// * [taskAction]
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> creditTasksIdActionPost({
    required String id,
    required TaskAction taskAction,
    String? xWalletIntent,
    String? xWalletSig,
    String? idempotencyKey,
    CancelToken? cancelToken,
    ...
    final _path = r'/credit/tasks/{id}/action'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
    ...
    try {
      _bodyData = jsonEncode(taskAction);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Task>> creditTasksPost({
    required String xWalletIntent,
    required String xWalletSig,
    required String idempotencyKey,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> creditTipPost({
    required String xWalletIntent,
    required String xWalletSig,
    required String idempotencyKey,
    required TipInput tipInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
