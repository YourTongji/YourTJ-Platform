...
class ReviewsApi {
  ...
  Future<Response<ReviewPage>> coursesIdReviewsGet({
    required String id,
    String? sort = 'hot',
    String? cursor,
    int? limit = 20,
    ...
    final _path = r'/courses/{id}/reviews'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Review>> coursesIdReviewsPost({
    required String id,
    required CreateReviewInput createReviewInput,
    ...
    try {
      _bodyData = jsonEncode(createReviewInput);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<Review, Review>(rawData, 'Review', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future] containing a [Response] with a [Review] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Review>> reviewsIdGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> reviewsIdLikeDelete({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/reviews/{id}/like'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> reviewsIdLikePost({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Review] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Review>> reviewsIdPatch({
    required String id,
    ...
    try {
      _bodyData = jsonEncode(reviewInput);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> reviewsIdReportPost({
    required String id,
    required ReviewsIdReportPostRequest reviewsIdReportPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(reviewsIdReportPostRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
