...
export type CheckInStatus = Schema["CheckInStatus"];
...
export type MediaReconciliationIssueCode = Schema["MediaReconciliationIssueCode"];
export type MediaReconciliationReport = Schema["MediaReconciliationReport"];
...
export type MediaDelivery = Schema["MediaDelivery"];
export type MediaDeliveryState = Schema["MediaDeliveryState"];
export type MediaDeliveryVariant = Schema["MediaDeliveryVariant"];
