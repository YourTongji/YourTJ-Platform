...
>
> 最近核验：2026-07-12，migrations `0054`–`0056`、owner-domain integration tests 与 Web tests
...
| 运维 | `Partial` | 通知 outbox 有持久状态、错误码、dead-letter 列表和审计人工重试；其他设置仍为 string key/value，通用任务只确认提交，无持久状态、进度、失败日志和重试；缺告警、SLO/恢复演练 |
