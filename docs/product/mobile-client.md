...
| secondary surface | `#F0FDFA` | `#163D35` |
| secondary foreground | `#00796B` | `#80E7D2` |
| muted/accent | `#ECEEEC` | `#1B302B` |
| muted foreground | `#596562` | `#9CB8B2` |
| border | `#E1E3E1` | `#29433D` |
| input | `#BCC9C6` | `#3B5D55` |
| destructive | `#D4183D` | `#FF6B81` |
